...
urlpatterns = [
    ...
    path("calendar/filter_note/",get_notes_based_on_date,name="filter_notes_based_on_date"), #http://127.0.0.1:8000/api/calendar/filter_note/?start_date=2025-04-05&end_date=2025-04-05
